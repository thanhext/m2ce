<?php
namespace AstralWeb\Banner\Block\Adminhtml\Item\Edit;
/**
 * Class Tabs
 * @package AstralWeb\Banner\Block\Adminhtml\Item\Edit
 */
    ...
    protected function _beforeToHtml()
    {
        $this->addTab(
            ...
            [
                'label' => __('General'),
                'title' => __('General'),
                'content' => $this->getLayout()->createBlock('AstralWeb\Banner\Block\Adminhtml\Item\Edit\Tab\Info')->toHtml(),
                'active' => true
            ]
        );
//        $this->addTab(
