...
use Ecommage\Blog\Helper\Data as PostHelper;
...
class Post extends AbstractModel implements PostInterface, IdentityInterface
{
     ...
     * No route post id
     */
    const NOROUTE_POST_ID = 'no-route';
    /**#@+
     * Page's Statuses
     */
    ...
    {
        $this->_init(\Ecommage\Blog\Model\ResourceModel\Post::class);
    }
     ...
     * Load No-Route Post
     *
     * @return \Ecommage\Blog\Model\Post
     */
    ...
    {
        $originalIdentifier = $this->getOrigData(Data::FIELD_URL_KEY);
        ...
        switch ($originalIdentifier) {
            case $this->getScopeConfig()->getValue(PostHelper::XML_PATH_NO_ROUTE_POST):
                throw new LocalizedException(
                    __('This identifier is reserved for "Blog No Route Post" in configuration.')
                );
            case $this->getScopeConfig()->getValue(PostHelper::XML_PATH_HOME_POST):
                throw new LocalizedException(__('This identifier is reserved for "Blog Home Post" in configuration.'));
            case $this->getScopeConfig()->getValue(PostHelper::XML_PATH_NO_COOKIES_POST):
                throw new LocalizedException(
                    __('This identifier is reserved for "Blog No Cookies Post" in configuration.')
                );
        }
    ...
    {
        // TODO: Implement getPostLayout() method.
    }
     ...
     *
     * @param string $pageLayout
     * @return \Ecommage\Blog\Api\Data\PostInterface
     */
    public function setPostLayout($pageLayout)
    {
        // TODO: Implement setPostLayout() method.
    }
}
